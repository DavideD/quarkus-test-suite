...
//    @Container(image = "ibmcom/db2:11.5.5.1", port = 50000, expectedLog = "Setup has completed")
...
//            .withDatabase(DB2_DATABASE);
    ...
    static RestService app = new RestService().withProperties("db2.properties")
            ...
            .withProperty("quarkus.datasource.reactive.url", "db2://localhost:50000/amadeus");
